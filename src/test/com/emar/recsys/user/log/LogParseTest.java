...
public class LogParseTest {
	...
	private static String[][] t_data = new String[][] {
				...
				"1375959604006552536361", "13759596003735015414", null, "218.21.40.26"},
		{
				...
				"dec8d1d4-2576-44e9-9b0e-0c5a9281183d\u000113786350768180461255\u0001130908QGJP76\u0001\u0001\u000145.0\u00011\u00018070\u00018070\u000145.0\u0001139\u000120130908200110\u0001yihaodian.com\u00011377660187591464491565",
				"1377660187591464491565", "13786350768180461255", null, null},
...
//				""} 
	...
	private static final String[] t_fields = new String[] {  
	...
	public void testGetField() {
		...
		for (int i = 0; i < t_fields.length; ++i)
			t_obj.getField(t_fields[i]);
	}
	
	@Test
	public void testbuildUidKey() {
		// TODO
	}
	...
	public void testparse() throws ParseException { 
		for (int i = 0; i < t_data.length; ++i) {
			t_obj.parse(t_data[i][1], t_data[i][0]);
			for (int j = 0; j < t_fields.length; ++j) {
				Assert.assertEquals(t_obj.getField(t_fields[j]), t_data[i][j+2]);
			}
		}
	}
