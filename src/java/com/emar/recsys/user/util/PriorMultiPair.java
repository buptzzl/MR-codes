 ...
 * 
 */
public class PriorMultiPair implements WritableComparable<PriorMultiPair> {
	private Text key;
	...
	public PriorMultiPair() {
		this.setKV(new Text(), new VIntWritable(0));
	}

	public PriorMultiPair(Text k, VIntWritable f) {
		this.setKV(k, f);
	}

	public PriorMultiPair(Text t) {
		this.setKV(t, new VIntWritable(0));
	}

	public PriorMultiPair(String s) {
		this.setKV(new Text(s), new VIntWritable(0));
	}

	public PriorMultiPair(String s, int b) {
	...
	public boolean equals(Object obj) {
		if (obj == null || !(obj instanceof PriorMultiPair)) {
			return false;
		}
		if (obj == this) {
			return true;
		}
		return this.key.equals(((PriorMultiPair) obj).getFirst());
	}

	@Override
	public int compareTo(PriorMultiPair obj) {
