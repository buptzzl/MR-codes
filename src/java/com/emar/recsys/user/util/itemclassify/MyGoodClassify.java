...
//	private Text word = new Text();
	...
	static {
		try {
			...
			DistributedCache.addCacheFile(new URI(
					"/user/hadoop/wzcconfig/fourthdict#fourthdict"), conf);
			DistributedCache.addCacheFile(new URI(
			...
			DistributedCache.addCacheFile(new URI(
					"/user/hadoop/wzcconfig/districtwords#districtwords"), conf);
			DistributedCache.addCacheFile(new URI(
			...
			System.err.print("set MyGoodClassify base classify file error!");
			initstat = false;
			System.exit(1);
		}// 这个也是可以的
	}
	...
	public void setup(Context context) throws IOException {
		...
		Configuration conf = MyGoodClassify.conf;  // context.getConfiguration();
		localFiles = DistributedCache.getLocalCacheFiles(conf);
	...
	public void map(Object key, Text value, Context context)
		...
		String aword = value.toString();
		String result = ClassifyGoods(aword);
		word.set(aword);
	...
	*/
	...
	private MyGoodClassify() { };  
	private static MyGoodClassify Cgood= null;
	public static MyGoodClassify getInstance() throws IOException {
		if(Cgood == null) {
			Cgood = new MyGoodClassify();
			Cgood.setup(null);
		}
		return Cgood;
	}
	...
	public static void main(String[] argv) {
		MyGoodClassify my;
		try {
			my = MyGoodClassify.getInstance();
			System.out.print("[test] hsCode2CateName-size: " + hsCode2CateName.size());
			String item = "葡萄酒100ml";
			System.out.print("[test] " + my.ClassifyGoods(item));
		} catch (IOException e) {
			System.err.print("failed to load MyGoodClassify data.");
			System.exit(2);
		}
	}
