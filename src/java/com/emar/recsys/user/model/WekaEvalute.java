...
public class WekaEvalute {
	...
	public WekaEvalute(String in) throws Exception {
		this.in = in;
	...
	public WekaEvalute(String outeva, String outmodel, String in, String model, int cidx, int Ncs) throws Exception {
		this.in = in;
		this.outEva = outeva;
